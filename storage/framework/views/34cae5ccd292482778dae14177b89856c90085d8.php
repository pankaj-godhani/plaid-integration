 <?php $__env->startSection('title', 'Plaid Check'); ?>
  ...
  <div class="m-4" x-data>
    ...
    <div class="bg-gray-200 p-8 rounded-lg shadow-lg max-w-md">
      ...
      <div class="flex flex-col text-center items-center mt-8">
        ...
        <a id="continue" href="<?php echo e(url('/initial-payment?deal_id=' . $deal_id . '&total=' . $total . '&products=' . $products)); ?>">
...
<?php $__env->startPush('additional-scripts'); ?>
<script src="https://cdn.plaid.com/link/v2/stable/link-initialize.js"></script>
<script>
  $(document).ready(() => {
    const dealId = "<?php echo e($deal_id); ?>";
    const total = "<?php echo e($total); ?>";
    const products = "<?php echo e($products); ?>";
    const plaidOptions = {
      apiVersion: "<?php echo e(env('PLAID_API_VERSION')); ?>",
      clientName: "<?php echo e(env('PLAID_CLIENT_NAME')); ?>",
      env: "<?php echo e(env('PLAID_ENV')); ?>",
      webhook: "<?php echo e(env('PLAID_WEBHOOK')); ?>",
      product: ["assets", "transactions", "auth"],
      key: "<?php echo e(env('PLAID_API_KEY')); ?>",
      countryCodes: "<?php echo e(env('PLAID_COUNTRY_CODES')); ?>".split(','),
    };
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.0\htdocs\plaid\resources\views/gateway/plaid.blade.php ENDPATH**/ ?>